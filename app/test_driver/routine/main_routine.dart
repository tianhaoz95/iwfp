...
Future<void> smokeTestRoutine(FlutterDriver driver) async {
  ...
  bool drawerLayout = await isDrawerLayout(driver);
  if (signedIn) {
    await gotoHomeTab(driver, drawerLayout, 'user_nav_btn');
  ...
  await gotoHomeTab(driver, drawerLayout, 'cards_nav_btn');
  ...
  await gotoHomeTab(driver, drawerLayout, 'contrib_nav_btn');
