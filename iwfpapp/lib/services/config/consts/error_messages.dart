...
final String promoStartEmptyErrorMessage = 'Promotion start date cannot be empty.';
final String promoEndEmptyErrorMessage = 'Promotion end date cannot be empty.';
final String promoRepeatEmptyErrorMessage = 'Promotion repeat pattern cannot be empty.';
final String promoRateNotIntErrorMessage = 'Promotion rate should be an integer.';
