...
CreditCard discoverItCashbackCreditCard =
    CreditCard('Discover it Cashback Credit Card', 'discover_it_cashback_credit_card', promos: [
  CashbackPromo('Grocery Stores', 'grocery_stores', 'sector', '01/01', '03/31',
      'annual', 5, ShopCategory('Grocery Stores', 'grocery_stores')),
  ...
  CashbackPromo('PayPal', 'paypal', 'payment', '07/01', '09/30', 'annual', 5,
      ShopCategory('PayPal', 'paypal')),
  CashbackPromo('Amazon.com', 'amazon', 'brand', '10/01', '12/31', 'annual', 5,
