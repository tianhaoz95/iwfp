            ...
            child: Column(
              children: <Widget>[
                ...
                Text('Promotion ID: ' + promo.id,
                    style: TextStyle(color: Colors.white)),
                Text('Promotion Type' + promo.type, style: TextStyle(color: Colors.white)),
                Text('Promotion Duration: ' + promo.start + '~' + promo.end,
                    style: TextStyle(color: Colors.white)),
                Text('Promotion Repeat Pattern: ' + promo.repeat, style: TextStyle(color: Colors.white)),
                Text('Promotion Cashback Rate: ' + promo.rate.toString() + '%',
                    style: TextStyle(color: Colors.white)),
                Text('Promotion Target Name: ' + promo.category.name,
                    style: TextStyle(color: Colors.white)),
                Text('Promotion Target ID: ' + promo.category.id, style: TextStyle(color: Colors.white)),
                RaisedButton(
