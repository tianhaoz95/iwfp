...
echo "storeFile=\"$HOME/$SECRET_REPO/iwfp/key.jks\"" >> ./iwfpapp/android/key.properties

rm -f ./iwfpapp/android/fastlane/Appfile
echo "json_key_file \"$HOME/$SECRET_REPO/iwfp/play_store_service_account_api_key.json\"" >> ./iwfpapp/android/fastlane/Appfile
