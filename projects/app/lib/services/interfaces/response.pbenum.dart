...
class HttpBasedResponse_Status extends $pb.ProtobufEnum {
  static const HttpBasedResponse_Status SUCCESS =
      HttpBasedResponse_Status._(0, 'SUCCESS');
  static const HttpBasedResponse_Status ERROR =
      HttpBasedResponse_Status._(1, 'ERROR');
  static const HttpBasedResponse_Status UNKNOWN =
      HttpBasedResponse_Status._(2, 'UNKNOWN');
